...
class Playlist:
  ...
  # Creates a method called add_song that creates a Song object and adds it to the playlist. This method has one parameter called title.
  ...
  # Creates a method called find_song that searches for whether a 
  ...
  # Creates a method called remove_song that removes a song from the playlist. 
  ...
  # Creates a method called length, which returns the number of songs in the playlist.
  ...
  # Creates a method called print_songs that prints a numbered list of the songs in the playlist.
